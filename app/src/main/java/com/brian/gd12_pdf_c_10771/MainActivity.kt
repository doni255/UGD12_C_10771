package com.brian.gd12_pdf_c_10771
...
import com.brian.gd12_pdf_c_10771.R
import com.brian.gd12_pdf_c_10771.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun createPdf(nama: String, umur: String, tlp: String, alamat: String, kampus: String) {
        ...
        val file = File(pdfPath, "pdf_10771.pdf")
        ...
        @SuppressLint("UserCompatLoadingForDrawables") val d = getDrawable(R.drawable.dog)
        ...
        table.addCell(Cell().add(Paragraph(java.time.LocalTime.now().format(timeFormatter))))
